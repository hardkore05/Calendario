...
// =========================
const usuarios = {
  "48217": { nombre: "Alcaldía Local de Engativá", oficina: "Alcaldía Local de Engativá", rol: "admin" },
  "73105": { nombre: "Área de Gestión de Desarrollo Local", oficina: "Área de Gestión de Desarrollo Local", rol: "admin" },
  "26493": { nombre: "Pilar Social", oficina: "Pilar Social", rol: "admin" },
  "51842": { nombre: " ", oficina: " ", rol: "user" },
  "93671": { nombre: "Casa Afro", oficina: "Casa Afro", rol: "user" },
  "40726": { nombre: "Instancias de Participación", oficina: "Instancias de Participación", rol: "user" },
  "65218": { nombre: "Salud", oficina: "Salud", rol: "user" },
  "18395": { nombre: "Educación", oficina: "Educación", rol: "user" },
  "82460": { nombre: "Subsidio Bono C", oficina: "Subsidio Bono C", rol: "user" },
  "37514": { nombre: "Casa Mujer Respiro", oficina: "Casa Mujer Respiro", rol: "user" },
  "60937": { nombre: "Casa del Adulto Mayor", oficina: "Casa del Adulto Mayor", rol: "user" },
  "94152": { nombre: "Casa del Adulto Mayor", oficina: "Casa del Adulto Mayor", rol: "user" },
  "21684": { nombre: "Cultura y Deporte", oficina: "Cultura y Deporte", rol: "user" },
  "75309": { nombre: "Ambiente", oficina: "Ambiente", rol: "user" },
  "42861": { nombre: "Desarrollo Económico", oficina: "Desarrollo Económico", rol: "user" },
  "89534": { nombre: "Enlace Social", oficina: "Enlace Social", rol: "user" },
  "16275": { nombre: "PYBA", oficina: "PYBA", rol: "user" },
  "53708": { nombre: "Enlace de Participación", oficina: "Enlace de Participación", rol: "user" },
  "68421": { nombre: "Apoyo a la Supervisión", oficina: "Apoyo a la Supervisión", rol: "user" }
};
...
// =========================
const responsables = {
  "Instancias de Participación": "Instancias de Participación",
  "Salud": "Salud",
  "Educación": "Educación",
  "Subsidio Bono C": "Subsidio Bono C",
  "Casa Mujer Respiro": "Casa Mujer Respiro",
  "Casa Afro": "Casa Afro",
  "Casa del Adulto Mayor": ["Casa del Adulto Mayor", "Casa del Adulto Mayor"],
  "Cultura y Deporte": "Cultura y Deporte",
  "Ambiente": "Ambiente",
  "Desarrollo Económico": "Desarrollo Económico",
  "Área de Gestión de Desarrollo Local": "Área de Gestión de Desarrollo Local",
  "Pilar Social": "Pilar Social",
  "Enlace Social": "Enlace Social",
  "PYBA": "PYBA",
  "Alcaldía Local de Engativá": "Alcaldía Local de Engativá",
  "Enlace de Participación": "Enlace de Participación",
  "Apoyo a la Supervisión": "Apoyo a la Supervisión"
};
